...
class SensorLog(object):
    ...
    def write_touch_file(self,file_prefix):
        ...
        with open(self.log_path+"/validator_logging/contact_sensors/"+file_prefix+"_contacts.dat","w") as f:
            # Write the headers.
...
class Sensors(object):
    ...
    def clear_sensors(self):
        ...
        self.clear_touching()
        self.joint_angles = []
        for k,i in self.dist_sensors.iteritems():
            self.dist_sensors[k]['distance'] = 0
...
#                self.joints.append(joint_nums)
    ...
    def get_joint_sensors(self):
        ...
        for j in self.joints:
            ...
            if high1-low1 == 0:
                ...
                self.joint_angles.append(cur_pos/(high1-low1))
            ...
            if high2-low2 == 0:
                ...
                self.joint_angles.append(cur_pos/(high2-low2))
    ...
    def get_raw_distance(self,geom_num):
        ...
        """
        return self.dist_sensors[geom_num]['distance']
